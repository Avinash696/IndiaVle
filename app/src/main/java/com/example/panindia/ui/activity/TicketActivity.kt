...
//adult
    ...
    private fun adultPassangerSet(){
        arr.add(passangerCountModel((fName.text.toString() +"-"+lName.text.toString()),R.drawable.edit))
        ...
        val p1 = Passenger(addressString.text.toString(),addressString.text.toString(),city.text.toString(),contact.text.toString()
            ,countryCodeString,countryName.text.toString(), "1987-12-06T00:00:00",email.text.toString(),"6E",
