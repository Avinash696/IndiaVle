...
//adult
            btnSave.setOnClickListener {
                ...
                if (binding.lvAdultCount.size < adultCount) {
                    ...
                    Toast.makeText(this, "All Adult Passenger Detail Filled", Toast.LENGTH_LONG)
                        .show()
                }
            }
        }
...
//
                    ...
                    btnSave.setOnClickListener {
                        Log.d("savetest",
                            "onCreate Child: ${binding.lvChildCount.size} $childCount ")
...
//                    childCount -= 1
                            ...
                            Toast.makeText(this,
                                "All Child Passenger Detail Filled",
                ...
                binding.ivAddDetailsInfant.setOnClickListener {
                    ...
                    btnSave.setOnClickListener {
                        ...
                        Log.d("savetest",
                            "onCreate Infant: ${binding.lvInfantCount.size} $infantCount ")
...
//
                            ...
                            Toast.makeText(this,
                                "All Infant Passenger Detail Filled",
                                Toast.LENGTH_LONG).show()
                        }
                    }
                }
                ...
                binding.btSaveTicket.setOnClickListener {
                    Log.d("sizeCheck",
                        "btnSAve click: ${Gson().toJson(arrayListPassanger.size)} $sizeFarebreakdown")
                    if (arrayListPassanger.size == sizeFarebreakdown) {
                        hitTicket(tokenStr, traceIdStr, resultIndexStr, arrayListPassanger)
                    } else {
                        Toast.makeText(this, "Fill all Passenger details ", Toast.LENGTH_SHORT)
                            .show()
                    }
                }

                fun getValueFromDialog(dialog: Dialog) {
                    ...
                    passportExpiry =
                        dialog.findViewById<TextView>(R.id.tvPassportExpiryPassDetail)

                    //sp onclick
                    spTitle.onItemSelectedListener =
                    ...
                    spCountryCode.onItemSelectedListener =
                        object : AdapterView.OnItemSelectedListener {
                            override fun onItemSelected(
                                parent: AdapterView<*>,
                                view: View,
                    ...
                    spNationality.onItemSelectedListener =
                        object : AdapterView.OnItemSelectedListener {
                            override fun onItemSelected(
                                parent: AdapterView<*>,
                                view: View,
                ...
                private fun hitFareQuote(
                    tokenStr: String,
                    traceIdStr: String,
                    resultIndexStr: String,
                ) {
                    //now show data
                    val dummyObj = SendFareQuoteModel("192.168.11.58",
                        resultIndexStr,
                        tokenStr,
                        traceIdStr)
...
//            sizeFarebreakdown = it.Response.Results.FareBreakdown.size
                        ...
                        if (it.Response.Results.FareBreakdown.size == 1) {
                            ...
                            if (it.Response.Results.FareBreakdown.size == 1) {
                                ...
                                childCount = it.Response.Results.FareBreakdown[1].PassengerCount
                                infantCount =
                                    it.Response.Results.FareBreakdown[2].PassengerCount
...
//            Log.d("myChild", "hitFareQuote: $adultCount $childCount $infantCount")
                ...
                private fun hitTicket(
                    tokenStr: String, traceIdStr: String,
                    ...
                    fareQuote.repoTicketLiveData.observe(this) {
                        ...
                        if (it.Response.ResponseStatus == 1) {
                            ...
                            Log.d("onticket",
                                "hitTicket:  Error ${it.Response.Error.ErrorMessage} ")
                            Log.d("onticket",
                                "hitTicket:  Error ${Gson().toJson(arrayListPassanger)}")
                        }
                ...
                private fun adultPassangerSet() {
                    ...
                    arrAdult.add(passangerCountModel((fName.text.toString() + "-" + lName.text.toString()),
                        R.drawable.edit))
                    ...
                    val p1 = Passenger(addressString.text.toString(),
                        addressString.text.toString(),
                        city.text.toString(),
                        contact.text.toString(),
                        countryCodeString,
                        countryName.text.toString(),
                        "1999-12-06T00:00:00",
                        email.text.toString(),
                        "6E",
                        "123",
                ...
                private fun childPassangerSet() {
                    ...
                    arrChild.add(passangerCountModel((fName.text.toString() + "-" + lName.text.toString()),
                        R.drawable.edit))
                    ...
                    val p3 = Passenger(addressString.text.toString(),
                        addressString.text.toString(),
                        city.text.toString(),
                        contact.text.toString(),
                ...
                fun infantPassangerSet() {

                    arrInfant.add(passangerCountModel((fName.text.toString() + "-" + lName.text.toString()),
                        R.drawable.edit))
                    ...
                    val p2 = Passenger(addressString.text.toString(),
                        addressString.text.toString(),
                        city.text.toString(),
                        contact.text.toString(),
                        countryCodeString,
