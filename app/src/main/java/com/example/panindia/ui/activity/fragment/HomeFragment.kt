...
//        binding = FragmentHome2Binding.inflate(R.layout.fragment_home2, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.llPanCard.setOnClickListener {  startActivity(Intent(requireContext(), PanCardActivity::class.java))}
           binding.llAeps.setOnClickListener {startActivity(Intent(requireContext(), AepsActivity::class.java))}
        binding.llMoneyTransfer.setOnClickListener { startActivity(Intent(requireContext(), MoneyTransferActivity::class.java))}
        binding.llbbps.setOnClickListener {startActivity(Intent(requireContext(), BbpsActivity::class.java))}
        binding.llflight.setOnClickListener {startActivity(Intent(requireContext(), FlightActivity::class.java))}
        binding.llRecharge.setOnClickListener { startActivity(Intent(requireContext(), RechargeActivity::class.java))}
        binding.llInsurance.setOnClickListener {startActivity(Intent(requireContext(), InsuranceActivity::class.java))}
        binding.llOthers.setOnClickListener { startActivity(Intent(requireContext(), OthersActivity::class.java))}
        binding.llothers2.setOnClickListener { startActivity(Intent(requireContext(), OthersActivity::class.java))}
    }
